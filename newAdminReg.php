...
<head>
    <title>New Administrator Registration</title>
    <meta charset="UTF-8">
...
<main class = "grid-container">
    ...
    <header>
        ...
        <section class = grid-30>
            ...
            <div id = "logout">
                <p>You are signed in as session-user</p>
    ...
    <section class = grid-100>
        ...
        <div id = "regForm">
            <form method="post" action="newAdminReg.php" id = "regF">
                <?php include('errors.php'); ?>
                <div id = "title">
                    <p> Register New Administrator</p>
                </div>
                <div class="input">
                ...
                <div class="input">
                    <button type="submit" class="fakeButton" name="register">Register new Administrator</button>
                </div>
            </form>
        </div>
    </section>
